...
//创建和初始化地图函数：
    ...
    function createMap(){
        ...
        var point = new BMap.Point(113.003658,28.198628);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"我的标记",content:"我的备注",point:"112.979942|28.201048",isOpen:0,icon:{w:16,h:16,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
